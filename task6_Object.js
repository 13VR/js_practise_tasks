...
taskTitle.innerText = "Task 5: Object";
...
let personLarge = {
  ...person,
  address: { street: "123 Main st", city: "New Yourk", country: "USA" },
...
// object[property] // object['director']
...
let user = {
  ...
  age: 25,
  introduce() {
    return "My name is John and I am 25 years old";
  },
...
// Розкоментуйте рядок нижче після виконня завдання для перевірки
console.dir(newArr, "<<<<"); // Виведе myProperty
...
// addProperty(example, "firstName", "Alex");
// addProperty(example, "lastName", "Smith");
// addProperty(example, "age", 20);
