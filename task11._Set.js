...
taskTitle.innerText = "Task 11: Set множина ";
...
function checkValueAndType(mySet, value) {
  if (mySet.has(value)) {
    return `${value}" типу "${typeof value}`;
  } else {
